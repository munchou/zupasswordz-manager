...
requirements = python3, kivy==2.3.0, kivy_reloader, https://github.com/kivymd/KivyMD/archive/master.zip, pycparser==2.22, cryptography, asyncgui==0.6.3, asynckivy==0.6.4, attrs==24.2.0, materialyoucolor==2.0.9, plyer==2.1.0, psutil==5.9.8, sortedcontainers==2.4.0, androidstorage4kivy, bcrypt, pyperclip
...
#kivy_reloader: min API 24, includes recipes (hostpython3, libffi, openssl, sdl2_image, sdl2_mixer, sdl2_ttf, sqlite3, python3, sdl2, setuptools, pycparser, six, cffi, pyjnius, android, cryptography, kivy, certifi, idna, https://github.com/kivymd/kivymd/archive/master.zip, kivy_reloader, toml, requests, chardet, urllib3, materialyoucolor, asynckivy, attrs), built for archs (arm64-v8a)
