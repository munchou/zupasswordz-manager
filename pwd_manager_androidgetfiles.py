...
class SharedStorage:
    ...
    def copy_from_shared(self, shared_file):
        print("IN copy_from_shared")
        print("file requested:", shared_file)
        if shared_file == None:
            return None
        if api_version > 28:
            print("api > 28")
            ...
            print("uri", uri, "cache_file", cache_file)
        else:
            print("NOT api > 28")
    ...
    def _get_uri(self, shared_file):
        ...
        print("file_name = basename(shared_file):", file_name)
        ...
        if api_version > 28:
            ...
            print("location:", location, "self.selection:", self.selection)
        else:
